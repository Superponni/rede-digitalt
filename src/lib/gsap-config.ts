...
// MÅ være bak en window-guard: denne modulen er en klientmodul, men toppnivå-
// koden evalueres også under server-prerender, og ScrollTrigger.config() trenger
// DOM/window (ellers kaster den «Cannot read properties of undefined» og bryter
// bygget). registerPlugin over er derimot SSR-trygg.
